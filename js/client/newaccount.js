...
fetch("https://api.smashi.tv/api/details", {
        method: "POST",
        headers: {
...
fetch("https://api.smashi.tv/api/current/subscription", {
    method: "GET",
    headers: {
        Authorization: `Bearer ${token}`,
        'Accept': 'application/json',
...
fetch("https://api.smashi.tv/api/v2/saved/video/list?user_id=" + user_id, {
        method: "GET",
        headers: {
