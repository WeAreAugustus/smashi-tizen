...
//               <div id="subscriptionText" style="text-align: center;position: absolute;z-index: 999;top: 20%;right: 35.5%;font-family: 'Raleway';font-style: normal;font-weight: 600;font-size: 56px;line-height: 66px;">
//               <p>Get Premium</p>
//               <p>To Continue Watching</p>
//               <button id="00010002" style="margin-top: -20%;background: rgba(56, 56, 56, 0.8);border: none;" class="subButtonMain"
//               onkeypress="toAccount()">
//               <p id="subscribeButtonText" >Start 7 days Free Trial</p>
//           </button>
//           </div>
//               <i class="dot"></i><h2  style="padding: 20px;display: inline-block;" lang-value="livenow"></h2>
//    <div id="liveVideoPlayer" style="filter: blur(15px);color:white !important;" class='player'>
...
//                    <div class='volume'>
//                        <button id="volumeB" class='volume-btn loud'>
...
//                    </div>
//                </div>
//                <button id="00020002" class='play-btn'></button>
...
//                        </ul>
//                    </div>
//                    <button id="00030002" class='fullscreen'>
...
//    // document.getElementById("textIntro").style.display = "";
//    // document.getElementById("topSectionNonSub").style.display = "";
//    // document.getElementById("coloredSeparatorContainer").style.display = "";
//    // document.getElementById("introSubText").style.display = "";
//
//
//} else {
//    document.getElementById("controlsView").style.display = "";
//    document.getElementById("liveVideoPlayer").style.filter = "blur(0px)";
//    document.getElementById("subscriptionText").remove();
//    
//    document.getElementById("volumeB").setAttribute("id", "00010002");
//    document.getElementById("00030001").setAttribute("id", "00020001");
//    document.getElementById("00040001").setAttribute("id", "00030001");
//
//    
//    //  document.getElementById("blur").style.display = "none";
//    document.getElementById("00020001").setAttribute("id", "00010001");
//    //document.getElementById("topSectionSub").style.display = "";
//    //document.getElementById("textIntro").style.top = "210px";
//
//}
//
//
